...
_(Ensure you have a folder named 'screenshots' in your repo for these to work)_
![Operational View](screenshots/page2_seller_analysis.png)
![Executive View](screenshots/page1_executive_summary.png)
